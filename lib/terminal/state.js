...
TerminalState.prototype._createLine = function () {
	return new Line(this._currentAttributes);
};
...
TerminalState.prototype.

TerminalState.prototype.moveCursor = function (row, col, createNewLines) {
	this.cursor.x = row;
	this.cursor.y = col;

	this._enforceCursorBounds(createNewLines);

	return this;
};

TerminalState.prototype.moveCursorRelative = function (numRows, numCols, createNewLines) {
...
TerminalState.prototype._enforceCursorBounds = function (createNewLines) {
